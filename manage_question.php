...
<h2>Edit Question</h2>     
        ...
        <?php
            ...
            // Insert Picture.
            function mCrowdMySQL_InsertPicture() {
            $study_id=$_GET["study_id"];
            $target_dir = "pics/";
            ...
            $servername = "127.0.0.1";
             ...
             echo $Question;
                try {
                    ...
                    echo "INSERT INTO questions (study_id,text,image_url) 
            ...
            // Check if image file is a actual image or fake image
                ...
                // Check file size
                if ($_FILES["fileToUpload"]["size"] > 500000) {a
